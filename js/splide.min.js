...
t = function() {
    ...
    var Vn = "role"
      ...
      , et = "fade";
    function ct(u, r, i, o) {
        var e, n = En(u), c = n.on, f = n.emit, a = n.bind, t = n.destroy, s = u.Components, l = u.root, d = u.options, v = d.isNavigation, h = d.updateOnMove, p = s.Direction.resolve, g = X(o, "style"), m = -1 < i, y = O(o, "." + Fn), w = d.focusableNodes && J(o, d.focusableNodes);
        function _() {
            var n;
            e || (n = u.index,
            b.call(this, x()),
    ...
    var pt = Object.freeze({
        ...
        Elements: function(n, t, i) {
            var r, u, o, e, c = En(n).on, f = n.root, a = {}, s = [];
            function l() {
                var n;
                !function() {
                    u = O(f, "." + Pn),
        ...
        Slides: function(r, u, o) {
            ...
            return {
                ...
                add: function(n, u) {
                    b(n, function(n) {
                        var t, i, r;
                        y(n = D(n) ? Y(n) : n) && ((t = f[u]) ? z(n, t) : E(a, n),
                        L(n, o.classes.slide),
                        n = n,
                        i = e.bind(null, xn),
                        n = J(n, "img"),
        ...
        Layout: function(n, t, i) {
            var r, u = En(n), o = u.on, e = u.bind, c = u.emit, f = t.Slides, a = t.Direction.resolve, s = (t = t.Elements).track, l = t.list, d = f.getAt;
            function v() {
                r = "ttb" === i.direction,
            ...
            function h() {
                C(s, "height", function() {
                    var n = "";
                    r && (Q(n = g(), "height or heightRatio is missing."),
                    n = "calc(" + n + " - " + p(!1) + " - " + p(!0) + ")");
                    return n
                }()),
                f.style(a("marginRight"), V(i.gap)),
                f.style("width", (i.autoWidth ? "" : V(i.fixedWidth) || (r ? "" : m())) || null),
                f.style("height", V(i.fixedHeight) || (r ? i.autoHeight ? "" : m() : g()) || null, !0),
                c(kn)
            }
            function p(n) {
                var t = i.padding
        ...
        Clones: function(c, n, f) {
            var t, i = En(c), r = i.on, u = i.emit, a = n.Elements, s = n.Slides, o = n.Direction.resolve, l = [];
            function e() {
                (t = p()) && (function(u) {
                    var o = s.get().slice()
                      , e = o.length;
            ...
            function p() {
                var n, t, i = f.clones;
                return c.is(ot) ? i || (n = a.list,
                D(t = f[o("fixedWidth")]) && (t = G(n = j("div", {
        ...
        Move: function(c, f, a) {
            var s, n = En(c), t = n.on, l = n.emit, r = (n = f.Layout).slideSize, i = n.getPadding, u = n.totalSize, o = n.listSize, e = n.sliderSize, d = (n = f.Direction).resolve, v = n.orient, h = (n = f.Elements).list, p = n.track;
            function g() {
                f.Scroll.cancel(),
                m(c.index),
                l(An)
            ...
            function _(n, t) {
                var i, i = v(u(n - 1) - (i = n,
                "center" === (n = a.focus) ? (o() - r(i, !0)) / 2 : +n * r(i) || 0));
                return t ? function(n) {
            ...
            return {
                ...
                move: function(n, t, i, r) {
                    ...
                    f.Transition.start(n, function() {
                        ...
                        u(3),
                        l(vn, t, i, n),
                        "move" === a.trimSpace && n !== i && o === b() ? f.Controller.go(i < n ? ">" : "<", !1, r) : r && r()
                    }))
                },
                jump: m,
                translate: y,
        ...
        Controller: function(n, e, u) {
            var o, c, f, t = En(n).on, a = e.Move, s = a.getPosition, l = a.getLimit, i = e.Slides, d = i.isEnough, r = i.getLength, v = n.is(ot), h = n.is(ut), p = u.start || 0, g = p;
            function m() {
                o = r(!0),
                c = u.perMove,
                f = u.perPage,
            ...
            function b(n, t) {
                var i, r, u = c || (R() ? 1 : f), o = x(p + u * (n ? -1 : 1), p);
                return -1 !== o || !h || (i = s(),
                r = l(!n),
                u = 1,
            ...
            function x(n, t, i) {
                var r;
                return d() ? (r = k(),
                n < 0 || r < n ? n = on(0, n, t, !0) || on(r, t, n, !0) ? L(E(n)) : v ? c ? n : n < 0 ? -(o % f || f) : o : u.rewind ? n < 0 ? r : 0 : -1 : v || i || n === t || (n = c ? n : L(E(t) + (n < t ? -1 : 1)))) : n = -1,
                n
            }
            function k() {
                var n = o - f;
                ...
                go: function(n, t, i) {
                    var r = function(n) {
                        var t = p;
                        {
                            ...
                            i = r[1],
                            r = r[2],
                            "+" === i || "-" === i ? t = x(p + +("" + i + (+r || 1)), p, !0) : ">" === i ? t = r ? L(+r) : w(!0) : "<" === i && (t = _(!0))) : t = v ? en(n, -f, o + f - 1) : en(n, 0, k())
                        }
                        return t
                    }(n);
                    u.useScroll ? y(r, !0, !0, u.speed, i) : -1 < (n = A(r)) && !a.isBusy() && (t || n !== p) && (S(n),
                    a.move(r, n, g, i))
                },
                scroll: y,
                getNext: w,
        ...
        Arrows: function(u, n, i) {
            var r, t = En(u), o = t.on, e = t.bind, c = t.emit, f = i.classes, a = i.i18n, s = n.Elements, l = n.Controller, d = s.arrows, v = s.prev, h = s.next, p = {};
            function g() {
                var n, t;
                i.arrows && (v && h || (d = j("div", f.arrows),
                v = m(!0),
                h = m(!1),
                r = !0,
                E(d, [v, h]),
        ...
        Autoplay: function(n, t, r) {
            var i, u, o, e = En(n), c = e.on, f = e.bind, a = e.emit, s = t.Elements, l = zn(r.interval, n.go.bind(n, ">"), function(n) {
                var t = s.bar;
                t && C(t, "width", 100 * n + "%");
            ...
            function h() {
                d() && t.Slides.isEnough() && (l.start(!r.resetProgress),
                u = i = o = !1,
                a("autoplay:play"))
            }
            function p(n) {
        ...
        Scroll: function(c, n, f) {
            var a, s, t = En(c), i = t.on, l = t.emit, d = n.Move, v = d.getPosition, h = d.getLimit, p = d.exceededLimit;
            function g(r, n, t, u) {
                var i, o = v(), e = 1;
                n = n || (i = un(r - o),
                nn(i / 1.5, 800)),
        ...
        Drag: function(r, u, o) {
            var e, c, f, a, s, l, d, i, v, n = En(r), t = n.on, h = n.emit, p = n.bind, g = n.unbind, m = u.Move, y = u.Scroll, w = u.Controller, _ = u.Elements.track, b = (n = u.Direction).resolve, x = n.orient, k = m.getPosition, A = m.exceededLimit, L = {
                passive: !1,
                capture: !0
            }, E = !1;
            function z() {
            ...
            function S(n) {
                var t;
                i || (!(t = I(n)) && n.button || (m.isBusy() ? U(n, !0) : (v = t ? _ : window,
                a = f = null,
                d = !1,
                p(v, ft, R, L),
                p(v, at, P, L),
            ...
            function R(n) {
                var t, i;
                a || h("drag"),
                (a = n).cancelable && (l ? (t = 200 < F(n) - F(c),
                i = E !== (E = A()),
                (t || i) && D(n),
            ...
            function P(n) {
                ...
                g(v, ft, R),
                g(v, at, P),
                a && ((l || n.cancelable && O()) && (t = function(n) {
                    if (r.is(ot) || !E) {
                        var t = c === a && f || c
                          , i = T(a) - T(t)
                          , t = F(n) - F(t)
                ...
                i = t,
                i = k() + cn(i) * $(un(i) * (o.flickPower || 600), s ? 1 / 0 : u.Layout.listSize() * (o.flickMaxPages || 1)),
                s ? w.scroll(i) : r.is(et) ? w.go(r.index + x(cn(t))) : w.go(w.toDest(i), !0),
                U(n)),
                h("dragged")),
                l = !1
            }
        ...
        Keyboard: function(t, n, i) {
            var r, u = En(t), o = u.on, e = u.bind, c = u.unbind, f = n.Elements.root, a = n.Direction.resolve;
            function s() {
                var n = i.keyboard
                  , n = void 0 === n ? "global" : n;
                n && ("focused" === n ? I(r = f, tt, 0) : r = window,
                e(r, "keydown", d))
            }
            function l() {
                c(r, "keydown"),
                    ...
                    o.lazyLoad && (r([ln, _n], function() {
                        ...
                        n.Slides.forEach(function(u) {
                            J(u.slide, vt).forEach(function(n) {
                                var t, i = X(n, lt), r = X(n, dt);
                                i === n.src && r === n.srcset || (I(t = j("span", o.classes.spinner, n.parentElement), Vn, "presentation"),
                                a.push({
                                    e: n,
                                    o: u,
                                    src: i,
        ...
        Pagination: function(l, n, d) {
            var v, t = En(l), i = t.on, r = t.emit, h = t.bind, u = t.unbind, p = n.Slides, g = n.Elements, o = n.Controller, m = o.hasFocus, e = o.getIndex, y = [];
            function c() {
                f(),
        ...
        Sync: function(i, n, r) {
            ...
            return {
                mount: function() {
                    ...
                    t([ln, bn], c),
                    I(e, Vn, "menu"),
                    n("navigation:mounted", i.splides)) : (o = [],
    ...
    function yt(o, n, e) {
        var c, t = En(o).bind, f = n.Move, a = n.Controller, i = n.Elements.list;
        function r() {
            s("")
        }
        function s(n) {
    ...
    i = function() {
        ...
        (r = [{
            ...
            set: function(n) {
                var t = this.f;
                l(t, n),
                this.state.is(1) || this.emit(bn, t)
            }
        }, {
            key: "length",
            get: function() {
